...
export const ROADMAP_CLOSING =
  "We do not recommend building everything today. The smartest route is to launch Cash Academy Digital, prove schools will subscribe, and allow each stage to be funded by the success of the previous stage. Every stage is designed to unlock the next level of growth.";
...
export const STAGES = [
  {
    ...
    outcome: "Launch Cash Academy online and begin selling curriculum subscriptions to schools.",
    purpose: null,
    features: [
      "Teacher Dashboard",
      "Curriculum Library",
    ...
    automations: [
      { trigger: "School Enquiry Submitted", action: "Confirmation Email" },
      { trigger: "School Subscription Purchased", action: "Welcome Email" },
      { trigger: "New School Added", action: "Access Email" },
      { trigger: "Subscription Due For Renewal", action: "Renewal Reminder" },
      { trigger: "New Curriculum Added", action: "School Notification" },
      { trigger: "Password Reset", action: "Automated Reset Email" },
    ],
    automationNote:
      "No CRM. No marketing automation. No lead generation. Only customer lifecycle automation.",
    investment: "£1,999",
    support: "£99/month",
    successMilestone: "10 paying subscription schools",
    implementAfter: null,
    revenueTarget: "£3,000 – £10,000",
    revenueTargetLabel: "Estimated Annual Revenue Goal",
    color: "blue",
  },
  {
    id: 2,
    ...
    outcome: "Create a predictable system for engaging schools and growing awareness.",
    purpose: "Move beyond workshop referrals and founder-led growth.",
    features: [
      "School CRM",
      "Lead Tracking",
      "Sample Lesson Downloads",
      "Lead Capture Forms",
      "Teacher Interest Database",
    ...
    investment: "£3,500",
    support: "£199/month",
    successMilestone: null,
    implementAfter: "25+ subscription schools or £15,000+ annual curriculum revenue",
    revenueTarget: "£15,000 – £50,000 per year",
  ...
  },
  {
    ...
    statusLabel: "Future Release",
    badge: "Future Release",
    outcome: "Become a complete curriculum platform rather than a resource library.",
    purpose: "Increase retention and create greater value for schools.",
    features: [
      "Assessment Resources",
      "Curriculum Mapping",
      "Progress Tracking",
      "School Reporting",
      "Ofsted Evidence Support",
    ...
    support: "£299/month",
    successMilestone: null,
    implementAfter: "75+ subscription schools or £50,000+ annual curriculum revenue",
    revenueTarget: "£50,000 – £150,000 per year",
    revenueTargetLabel: "Revenue Target",
    color: "blue",
  },
  {
    ...
    statusLabel: "Future Release",
    badge: "Future Release",
    outcome: "Extend financial literacy beyond the classroom.",
    purpose: "Create engagement with parents and children outside school.",
    features: [
      "Parent Portal",
      "Homework Activities",
      "Home Learning Tasks",
    ...
    support: "£399/month",
    successMilestone: null,
    implementAfter: "150+ subscription schools or £150,000+ annual curriculum revenue",
    revenueTarget: "£150,000 – £300,000+ per year",
    revenueTargetLabel: "Revenue Target",
    color: "yellow",
  },
  {
    ...
    statusLabel: "Future Release",
    badge: "Future Release",
    outcome: "National financial literacy platform.",
    purpose: "Create a market-leading educational ecosystem.",
    features: [
      "Student Accounts",
    ...
    successMilestone: null,
    implementAfter: "300+ schools or £300,000+ annual revenue",
    revenueTarget: "National Scale",
    revenueTargetLabel: "Revenue Target",
    color: "blue",
  },
];
